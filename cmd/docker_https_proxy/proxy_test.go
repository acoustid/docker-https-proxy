...
backend be_example_web
	...
	option httpchk GET /_health
	http-check expect status 200
	server-template srv_srv1_example_com_8080_ 100 srv1.example.com:8080 check
...
backend be_example_api
	...
	option httpchk GET /_health
	http-check expect status 200
	server-template srv_srv_api1_example_com_8081_ 100 srv-api1.example.com:8081 check
	redirect scheme https code 301 if !{ ssl_fc }
...
backend be_example2_default
	...
	server-template srv_srv1_example2_com_8090_ 100 srv1.example2.com:8090 check
`
